...
const resList = [
  ...
  },
  {
      "info": {
          ...
          "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/10/1/b5f05b4f-d78b-4ccf-a9b3-3b63a5db69f3_62965.jpg",
          "locality": "Minto Road",
          "areaName": "Connaught Place",
  ...
  },
  {
      "info": {
          "id": "21383",
          "name": "Subway",
          "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/9/17/0ba6460f-99d2-4daf-8ab0-d3a94494e7dc_21383.jpg",
  ...
  return (
    <div className="Card">
      ...
      <div className="res-container">
        {resList.map((resObj, index) => (
          <ResturantContainer key={index} resObj={resObj} />
        ))}
      </div>
    </div>
  );
